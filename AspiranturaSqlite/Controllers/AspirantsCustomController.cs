...
{
    public class AspirantsCustomController : Controller
    {
        private readonly AspiranturaContext _context;

        public AspirantsCustomController(AspiranturaContext context)
        {
            _context = context;
        }
        ...
        {
            ViewData["StatustypeId"] = new SelectList(_context.Statuses, "Id", "Name");      
            return View();
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["StatustypeId"] = new SelectList(_context.Statuses, "Id", "Name", aspirant.StatustypeId);
            return View(aspirant);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Surename,Patronymic,Birthday,DateInput,ProtectionDate,Protection,Course,StatustypeId")] Aspirant aspirant)
        {
            if (id != aspirant.Id)
            {
                return NotFound();
        ...
        //                           orderby s.Name
        //                           select s;
        //    ViewBag.StatusesId = new SelectList(statuses.AsNoTracking(), "StatusesId", "Name", selectedStatus);
        //}
    }
}
